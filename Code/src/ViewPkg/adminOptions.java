...
public class adminOptions extends JFrame {
	...
	public adminOptions() {
		...
		btnDeals.setBounds(72, 283, 175, 36);
		...
		btnLogOut.setBounds(256, 395, 127, 36);
		...
		btnHome.setBounds(72, 418, 89, 23);
		...
		lblNewLabel.setBounds(0, 0, 688, 473);
